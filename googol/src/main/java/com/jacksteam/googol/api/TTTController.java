...
public class TTTController{
    ...
    public String tttgamestart(){
        ...
        String out ="<style>.nested {padding-left: 20%;padding-right: 20%;display:grid;grid-template-columns:repeat(3, 1fr);grid-auto-columns: 200px;grid-auto-rows: 200px;grid-gap:1em;}</style>";
        ...
        if(game.checkForWin() || game.isBoardFull()){
            ...
            out += "<div class=\"container\"><h1>"+game.getCurrentPlayerMark() + ", enter an empty row and column to place your mark!"+"</h1></div>";
        }
