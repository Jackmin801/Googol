...
public class Controller{
    ...
    public String query(@RequestParam("q") String query){
        ...
        if(query.equalsIgnoreCase("c")){return "<head> <meta http-equiv=\"refresh\" content=\"0; URL=http://localhost:8080\" /></head>";}
        if(query.equalsIgnoreCase("x")){return "<head> <meta http-equiv=\"refresh\" content=\"0; URL=http://localhost:8080\" /></head>";}
        if(query.equalsIgnoreCase("b")){return "<head> <meta http-equiv=\"refresh\" content=\"0; URL=http://localhost:8080\" /></head>";}
        ...
        out += "<style>* {margin:0;padding:0;}a {color:#1e5631;font-weight: bold;}body {background-color:#1e5631;}h4{padding: 0;margin:0;color:#4c9a2a;}header{background-color: #1a4531;display:grid;grid-template-columns:1fr 4fr;}.container{background-color: #a4de02;padding: 1em;margin:1em;border-radius: 10px;}#form{margin: 7%;}#query{color:#999;padding:1em;width: 80%;}</style></head>";
